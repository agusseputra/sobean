class Penjual {
    ...
    factory Penjual.fromJson(Map<String, dynamic> json) => Penjual(
        ...
        foto: (json["foto"]  == null || json["foto"]  == "" || json["foto"]  == "NULL") ? 'https://www.siprotani.com/files/petani/no-image.jpg' : "https://www.siprotani.com/files/petani/"+json["foto"].toString(),
    );
