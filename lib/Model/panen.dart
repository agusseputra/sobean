...
class Panen {
    ...
    factory Panen.fromJson(Map<String, dynamic> json) => Panen(
        ...
        jumlahPerkiraanPanen: json["jumlah_perkiraan_panen"]==null?'':json["jumlah_perkiraan_panen"] as String,
        tglPanen: json["tgl_panen"] == null ? '' : json["tgl_panen"] as String,
        jumlahRiilPanen: json["jumlah_riil_panen"]==null?'':json["jumlah_riil_panen"] as String,
        ...
        foto: json["foto"]==null ? 'http://www.siprotani.com/files/images/1604215496download%20(5).jpg': json["foto"] as String,
