...
class Panen {
    ...
    factory Panen.fromJson(Map<String, dynamic> json) => Panen(
        ...
        foto: (json["foto"]==null || json["foto"]  == "" || json["foto"]  == "NULL") ? 'https://www.siprotani.com/files/images/no-image_list.png': "https://www.siprotani.com/files/panen/"+json["foto"].toString(),
